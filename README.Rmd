...
> A toolkit for auditing, cleaning, and visualizing messy financial datasets in R.

## Overview

`finclean` is an R package designed to help analysts and data scientists clean
and diagnose the messy, inconsistent data commonly found in real-world financial
datasets. It provides a set of simple but powerful functions for parsing currency
strings, standardizing fiscal year formats, normalizing account names, detecting
outliers, auditing data quality, and visualizing anomalies — all in one place.
...
`finclean` includes a built-in sample dataset `finclean_sample` containing
common data quality issues found in real-world financial data, including
inconsistent fiscal year formats, account name variations, messy currency
strings, outliers, and missing values.
