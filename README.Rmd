...
You can install `finclean` directly from GitHub using the `devtools` package:
...
`finclean` includes a built-in sample dataset `finclean_sample` — a small
data frame containing common data quality issues found in real-world financial
data, including inconsistent fiscal year formats, account name variations,
messy currency strings, outliers, and missing values.
